## The reason behind this code is because DMR analysis is NOT RUNNING when calling champ.DMR function (I do not know why, there is some error along the code).
## If we create the function in our environment, it can be performed. 
                      ...
                      C=2)
{
  ...
  }else if(method=="DMRcate")
  {
    ...
    dmrcoutput <- dmrcate(myannotation, min.cpgs = minProbes, lambda=lambda, C=C)
    #data(dmrcatedata)
